...
<style>
    ...
    * {
    ...
    .header__sp-menu-hide-btn,
    .header__sp-menu-opn-btn {
        float: right;
        display: none;
        z-index: 10
    }
    ...
    .top__button {
        ...
        display: block;
        border-radius: 3;
        background: -webkit-gradient(linear, left top, right top, from(#f74949), to(#ffb947));
        background: linear-gradient(90deg, #f74949, #ffb947);
        opacity: .8;
        letter-spacing: 2px;
        overflow: hidden
    }
    ...
    @media screen and (max-width:768px) {
        ...
        #menu {
            ...
            height: 100vh;
            overflow-y: hidden;
            background-color: #7c41cd;
            padding: 18px 26.25px 0
        }
