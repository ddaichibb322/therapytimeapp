...
<section class="plan-section">
    ...
    <div class="plan-section__container">
        <div class="plan-card">
            ...
            <p class="plan-card__discription"><b>マインドフルネス・瞑想を中心にセッションを受講して、精神的な効果を得たい方向けのコースです。</b><br>「ストレスや不安な気持ちを取り除きたい」<br>「集中力を高めたい」<br>「自己肯定感を高めて、自信をつけたい」<br>「瞑想を習慣化したい」<br>という方は、こちらのコースがおすすめです。<br>こちらのコースでは、スピリチュアル以外のセッションを受講可能です。</p>
            <p class="plan-card__caution">ユーザー登録後にログインした状態で、下記のボタンから入会いただけます。</p>
