...
<article class="main">
    ...
    <section class="news mt-3 mb-3">
        <p class="news-content mt-2 ml-3 mb-2">2019-09-22 TherapyTimeの公開間近です。</p>
        <p class="news-content mt-2 ml-3 mb-2">2019-09-19 TherapyTimeを実装中です。</p>
    </section>
    <section class="userinfo mt-3 mb-3">
        @if ($errors->any())
        ...
        @endif
        <form class="userinfo-form"  action="{{ url('/mypage/' . $user_data->id) }}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="form-group">
                <label for="name">ユーザ名</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="ユーザ名を入力してください" value="{{ $user_data->name }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="gender" name="gender">
                    <option value="" @if(empty($user_data->gender)) selected @endif>&nbsp</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="prefecture" name="prefecture">
                    <option value="" @if(empty($user_data->prefecture)) selected @endif>&nbsp</option>
            ...
            <div class="clearfix mt-5">
                <button type="submit" class="float-right btn btn-success d-block">更新する</button>
            </div>
            <a href="" class="link d-block mt-3 text-right">パスワード変更はこちらから</a>
