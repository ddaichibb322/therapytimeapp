...
<section class="plan-section">
    ...
    <div class="plan-card">
            ...
            <p class="plan-card__discription"><b>瞑想に興味はあるけどとりあえず費用を抑えて始めたい方や、短時間で手軽に瞑想を行いたい方向けのコースです。</b><br>「瞑想にあまり時間を割けないけれども、空いた時間や寝る前に手軽に瞑想したい」<br>「瞑想が初めてなので、とりあえず試してみたい」<br>という方には、まずはこちらのコースで始めて見ることをおすすめします。<br>こちらのコースでは、「ショート瞑想」のセッションのみが受講可能です。</p>
            @notpaiduser 
